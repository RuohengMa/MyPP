...
void OpOutputDebugger::PrintOutput(const paddle::optional<phi::DenseTensor> dt,
  ...
  if (dt) {
    ...
    OpOutputDebugger::PrintOutput(new phi::DenseTensor(), backend);
  }
}
...
void OpOutputDebugger::PrintOutput(
  ...
  if (v_t) {
    ...
    OpOutputDebugger::PrintOutput(*(new std::vector<phi::DenseTensor>()),
                                  backend);
  }
}
...
void OpOutputDebugger::PrintOutput(
  ...
  if (v_t) {
    ...
    OpOutputDebugger::PrintOutput(
        *(new std::vector<const phi::DenseTensor *>()), backend);
  }
}
